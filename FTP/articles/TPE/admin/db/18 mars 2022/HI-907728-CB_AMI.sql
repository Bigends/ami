...
--
-- Hôte : localhost:3306
-- Généré le : ven. 18 mars 2022 à 19:06
...
(9, 'SPIN15 - Caisse Pi', 'Diagonale d\'écran de 38cm, processeur Intel Arm9. 6 imprimantes connectables. 3 ports USB, 3 ports COM (RS-232), Ethernet. Lecteur de clé PPI (reconnaissance utilisateurs). Seule ou en réseau (avec d’autres SPIN 15, SPIN 8, SPIN PAD). Gestions des tables, plan de salle, séparation de table et de note. Gestion des règlements et différent mode de paiement, 3 niveaux de prix et gestion horaire des prix, Gestion des réservations, Comptes clients, Gestion des stocks, Lecteur de bande magnétique', '1647620680.jpg', 'Pi ELECTRONIQUE'),
