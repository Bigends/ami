...
--
-- Hôte : localhost:3306
-- Généré le : jeu. 24 mars 2022 à 13:32
...
(14, 'PAX Q30', 'Le Q30 est un clavier NIP intelligent intégré de nouvelle génération permettant aux commerçants de détail multivoies de se connecter à tout type de caisse enregistreuse, de borne de paiement en libre-service ou de terminal.', '1648124262.jpg', 'SMART PINPAD'),
(15, 'PAX A920Pro', 'Eléments clés de l\'A920Pro : Android 8.1 Processeur cortex A53 Ecran tactile 5.5 pouces capacitive 4G + WiFi + Bluetooth Sans contact + chip & PIN + piste magnétique PIN sur écran Caméra arrière 5MP Scanner professionel Batterie 5150mAh / 3V PCI PTS 5.x SRED', '1648123947.jpg', 'TERMINAL MOBILE ANDROID');
...
(1, 0, 'admin', '392766', '2022-03-21 14:13:46');
