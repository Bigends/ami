			...
			if($result)
			{
				if($result && mysqli_num_rows($result) > 0)
				{
					...
					if($user_data['password'] === $password)
					{
						...
						header("Location: TPE/admin/admin.php");
						die;
					}
				}
			}
...
<!doctype html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="https://alphamonetique.com/css/bootstrap.min.css">
        <link rel="stylesheet" href="https://alphamonetique.com/css/font-awesome.min.css">
        <link rel="stylesheet" href="https://alphamonetique.com/css/ionicons.min.css">
        <link rel="stylesheet" href="https://alphamonetique.com/css/css-plugins-call.css">
        <link rel="stylesheet" href="https://alphamonetique.com/css/bundle3.css">
        <link rel="stylesheet" href="https://alphamonetique.com/css/main6.css">
        <link rel="stylesheet" href="https://alphamonetique.com/css/responsive.css">
        <link rel="stylesheet" href="https://alphamonetique.com/css/colors.css">
        <link rel="stylesheet" href="https://alphamonetique.com/articles/TPE/admin/css/style.css">
        <link rel="stylesheet" href="https://alphamonetique.com/articles/assets/css/style.scss">
        <link rel="stylesheet" href="https://alphamonetique.com/articles/assets/css/style.css">
