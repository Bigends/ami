                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <nav class="woocommerce-breadcrumb">
                                <a href="">Catégorie</a>
                                <span class="separator">/</span> Système d'encaissement
                            </nav>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-md-9 shop-content">
                            ...
                            <img src="https://alphamonetique.com/assets/images/banner/caisse2.jpg" alt="">
                            </div>
                                ...
                                <div class="shop-page-product-area tab-content">
                                    <div id="list" class="tab-pane fade in show active">
                                        <div class="row">
                                            ...
                                            $req=$db->prepare('SELECT *FROM encaissement');
                                            $req->execute();
