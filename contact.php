                            ...
                            <div class="col-sm-12 col-md-12 col-lg-6 col-xs-12">
                                <div class="contact-form-inner">
                                    ...
                                    <form action="send.php" method="post">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <input type="text" name="mail" id="email" class="form-control" placeholder="Adresse mail*" required>
                                            </div>
                                            <div class="col">
                                        ...
                                        <div class="contact-submit">
                                            <input type="submit" name="submit" value="Envoyer" class="wpcf7-form-control wpcf7-submit button">
                                        </div>
                                    </form>
                                </div>
                            </div>
