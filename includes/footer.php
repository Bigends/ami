                            ...
                            <div class="col-sm-12 col-xl-9">
                                ...
                                <div class="newsletter">
                                    <div class="newsletter-box">
                                        <form action="#">
                                            <input class="subscribe" placeholder="votre adresse mail" name="email" id="subscribe" type="email">
                            ...
                            <div class="col-sm-12 col-xl-3">
                                <div class="footer-social">
                                    <ul class="social-icons">
                                        ...
                                        <li><a class="rss social-icon" href="#" title="Rss" target="_blank"><svg style="margin-top:15px" xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
