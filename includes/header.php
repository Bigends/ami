                    ...
                    <div class="container">
                        <div class="row">
                                ...
                                <div class="header-search clearfix">
                                    <div class="category-select pull-right">
                                        <select class="nice-select-menu">
                                            <option data-display="Tous les catégories">AMI</option>
                                            <option value="1">T.P.E</option>
                                            <option value="2">Monnayeur</option>
                                            <option value="3">Système d'encaissement</option>
                                            <option value="4">Solution paiement</option>
                                            <option value="5">Caméra de surveillance</option>
                                        </select>
                                    </div>
                            ...
                            <div class="col-xl-4 col-md-12">
                                <!-- shop-cart-menu -->
                                <div class="shop-cart-menu pull-right"><br>
                                    <ul>
                                        <li><a href="https://www.facebook.com/alphamonetiqueguyane/"><svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                                            <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                                          </svg></a></li>
                                        <li><a href="https://www.instagram.com/?hl=fr"><svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
