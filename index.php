                            ...
                            <div class="policy-area-inner">
                                ...
                                <div class="single-policy-area">
                                    <div class="single-policy">
                                        ...
                                        <h3>Support 24/7</h3>
                                        <p>Nos techniciens, à l'écoute </p>
                                    </div>
                                </div>
                                <div class="single-policy-area">
                                    <div class="single-policy">
                                        <div class="icon"><i class="icon ion-card"></i></div>
                                        <h3>Solution paiement</h3>
                                ...
                                <div class="single-policy-area">
                                    <div class="single-policy">
                                        ...
                                        <p>Nous assurons votre sécurité</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="product-wrapper listview">
                                            ...
                                            <div class="list-col8">
                                                <div class="product-info">
                                                    <h2><a href="single-product.html">Pack Maintenance</a></h2>
                                                    <span class="price">
                                                        Pro
                                                    </span>
